...
public static class SubscriptionEndpoints
{
    ...
    public static void MapSubscriptionEndpoints(this WebApplication app)
    {
        ...
        // The app offers no pause, but a payer can pause from their own Mercado Pago account.
    ...
    /// <summary>Runs an account-level billing action and answers with the whole refreshed overview.</summary>
