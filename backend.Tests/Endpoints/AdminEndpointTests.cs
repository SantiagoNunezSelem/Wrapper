...
public sealed class AdminEndpointTests(ApiFactory factory) : IClassFixture<ApiFactory>
{
    ...
    [InlineData("POST", "/api/admin/users/00000000-0000-0000-0000-000000000001/vip")]
    [InlineData("DELETE", "/api/admin/users/00000000-0000-0000-0000-000000000001/vip")]
    [InlineData("POST", "/api/admin/users/00000000-0000-0000-0000-000000000001/trial")]
