...
export const shellCopy = {
  es: {
      ...
      steps: {
        ...
        android: [
          ...
          },
          {
            ...
            body: 'Agregá un acceso directo de esta página a tu pantalla de inicio: la vas a tener a mano como cualquier otra app.',
            install: true,
          },
        ],
      },
    ...
    subscriptionPage: {
      ...
      pauseCta: 'Pausar',
      pausing: 'Pausando...',
      pauseConfirmTitle: '¿Pausar la suscripción?',
      pauseConfirmBody:
        'Dejamos de cobrarte y Mercado Pago guarda tu tarjeta y tu precio. La reactivás cuando quieras. Conservás el acceso hasta el {date}.',
      pauseConfirmYes: 'Sí, pausar',
      pauseHint: '¿Un mes complicado? Pausá en vez de cancelar y conservá tu precio.',
  ...
  en: {
      ...
      steps: {
        ...
        android: [
          ...
          },
          {
            ...
            body: "Add a shortcut to this page on your home screen: you'll have it at hand like any other app.",
            install: true,
          },
        ],
      },
    ...
    subscriptionPage: {
      ...
      pauseCta: 'Pause',
      pausing: 'Pausing...',
      pauseConfirmTitle: 'Pause the subscription?',
      pauseConfirmBody:
        'We stop charging you and Mercado Pago keeps your card and your price. Resume whenever you want. You keep access until {date}.',
      pauseConfirmYes: 'Yes, pause',
      pauseHint: 'Tight month? Pause instead of cancelling and keep your price.',
